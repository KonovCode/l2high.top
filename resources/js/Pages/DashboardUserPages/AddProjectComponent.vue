                    ...
                    <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                        ...
                        <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none bg-gray-300">
                            ...
                            <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                                ...
                                <div class="mb-4 md:flex md:justify-between">
                                    <div class="mb-4 md:mr-2 md:mb-0">
                                        <label class="block mb-2 text-sm font-bold text-gray-700" for="rates">
                                            Рейты
                                        </label>
                                        <input
                                            v-model="form.rates"
                                    ...
                                    <div class="md:ml-2">
                                        <label class="block mb-2 text-sm font-bold text-gray-700" for="date_open">
                                            Дата открытия
                                        </label>
                                        <input
...
export default {
    ...
    setup() {
        ...
        const rules = {
            ...
            website: { required, url, minLength: minLength(4), maxLength: maxLength(30) },
