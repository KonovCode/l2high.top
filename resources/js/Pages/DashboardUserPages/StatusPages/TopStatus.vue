<template>
    <BuyStatusComponent :status_name="'top'" :selected_project="select_project.data">
        <form @submit.prevent
            class="flex flex-col sm:flex-col lg:flex-row xl:flex-row md:flex-row justify-center items center my-10">
            <div class="py-12 sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-min sm:w-full bg-blue-300 z-30">
                ...
                <button @click="notification(top_services[3])" type="submit"
                    class="w-full mt-6 mb-3 py-2 text-white font-semibold bg-gray-700 hover:shadow-xl duration-200 hover:bg-gray-800">Купить</button>
            </div>
            <div
                class="py-12 my-3 md:my-0 sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-min sm:w-full bg-purple-500 transform scale-1 sm:scale-1 md:scale-105 lg:scale-105 xl:scale-105 z-40  shadow-none sm:shadow-none md:shadow-xl lg:shadow-xl xl:shadow-xl">
                ...
                <button @click="notification(top_services[5])" type="submit"
                    class="w-full mt-6 mb-3 py-2 text-white font-semibold bg-purple-400 hover:shadow-xl duration-200 hover:bg-purple-800">Купить</button>
            </div>
            <div class="py-12 sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-min sm:w-full bg-green-300 z-30">
                ...
                <button @click="notification(top_services[4])" type="submit"
                    class="w-full mt-6 mb-3 py-2 text-white font-semibold bg-gray-700 hover:shadow-xl duration-200 hover:bg-gray-800">Купить</button>
            </div>
        </form>
                ...
                switch (props.select_project.data.status) {
                    case ('default'):
                        ...
                        Swal.fire({
                            ...
                            text: 'Ваш проект получит все привилегии Top статуса',
                            icon: 'success',
                    ...
                    case ('top'):
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                Swal.fire({
                                    title: 'Спасибо за покупку!',
                                    text: 'Вы продлили Top статус на ' + service.show_term,
                                    icon: 'success',
                                    confirmButtonText: 'Хорошо'
                                });
                            }
                    ...
                    case ('vip'):
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                Swal.fire({
                                    title: 'Спасибо за покупку!',
                                    text: 'Ваш статус изменен на Top!',
                                    icon: 'success',
                                    confirmButtonText: 'Хорошо'
                                });
                            }
